...
int64 nChainStartTime = 1456967425;
...
const string strMessageMagic = "Tianniucoin Signed Message:\n";
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in Tianniucoin
    bool fStrictPayToScriptHash = true; // Always active in Tianniucoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Tianniucoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "vector esiz 799 mapBlockIndex Tianniucoin";
        CTransaction txNew;
        ...
        block.nNonce   = !fTestNet ? 270871 : 270871;
       ...
       // printf("block.nNonce = %u \n", block.nNonce);
		block.print();
		assert(block.hashMerkleRoot == uint256("0x9f7cacd2db5faa056b88792e0954b48a14c4a27c7badb68f78654621af40016e"));
